...
## 自由穿行与床品轻量化（2026-09-21）

按使用偏好取消全部墙体、家具碰撞，可自由穿行；眼高仍固定 1.5 m，房间导航可随时返回室内。两间卧室床品合计从约 30 万面减至约 6 万面，保留原贴图并重新烘焙光影；其他模型不变。全部模型、贴图及光影资源约 9.09 MB。具体测量和浏览器验证见 [性能记录](review/performance-2026-09-21.md)。
